 ...
 *
 * Los campos se enumeran uno a uno a proposito, y nunca se devuelve el modelo
 * entero. Un `return parent::toArray($request)` publicaria cualquier columna
 * que se anada a la tabla en el futuro sin que nadie lo decida: bastaria con
 ...
 *   - author_id / author  Identifica a una persona concreta de la institucion.
 *                         La web publica la firma, no el registro de usuario.
 *   - views_count         Metrica interna, no informacion publica.
 *   - status              Solo salen publicadas: el campo no aporta nada y
 *                         revelaria que existe contenido en otros estados.
