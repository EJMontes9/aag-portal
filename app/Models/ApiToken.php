...
/**
 * Token de acceso a la API pública.
 *
 * Es el PersonalAccessToken de Sanctum sin cambios de comportamiento: la misma
 * tabla, la misma lógica. Existe solo para tener un modelo dentro de App\Models
 ...
 * descubre sola ni la genera Shield. Con el modelo aquí, ApiTokenPolicy y los
