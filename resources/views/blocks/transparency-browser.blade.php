                                                    ...
                                                    <table class="w-full">
                                                        ...
                                                        <tbody>
                                                            @foreach($month['documents'] as $doc)
                                                                <tr class="border-t border-border first:border-0 hover:bg-brand-soft/30 transition-colors">
                                                                    <td class="px-4 py-2.5">
                                                                        <div class="flex items-center gap-3">
                                                                            {{-- Un solo tinte celeste para todas las extensiones: el
                                                                                 formato ya se lee en texto bajo el titulo, y B reserva
                                                                                 el color a estados, no a tipos de archivo. --}}
                                                                            <span class="inline-flex w-7 h-7 shrink-0 items-center justify-center rounded-pill bg-brand-soft text-brand-navy">
